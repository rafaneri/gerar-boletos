...
var Datas = (function () {
	...
	function validarData(data, anoAtual) {
	...
	Datas.prototype.comDocumento = function (_documento, locate = 'usa') {
		...
		if (!validarData(_documento, anoAtual)) {
			throw new Error('O ano do documento deve ser maior que 2010 e menor que ' + anoAtual);
		}
	...
	Datas.prototype.comProcessamento = function (_processamento, locate = 'usa') {
		...
		if (!validarData(_processamento, anoAtual)) {
			throw new Error('O ano do documento deve ser maior que 2010 e menor que ' + anoAtual);
		}
	...
	Datas.prototype.comVencimento = function (_vencimento, locate = 'usa') {
		...
		if (!validarData(_vencimento, anoAtual)) {
			throw new Error('O ano do documento deve ser maior que 2010 e menor que ' + anoAtual);
		}
...
var Boleto = (function () {
	var DATA_BASE = new Date(2010, 10 - 1, 7);
